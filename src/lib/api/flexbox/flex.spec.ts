...
describe('flex directive', () => {
  ...
  let componentWithTemplate = (template: string) => {
    ...
    inject([MatchMedia, StyleService, Platform],
      (_matchMedia: MockMatchMedia, _styler: StyleService, _platform: Platform) => {
  ...
  describe('with API directive queries', () => {
    it('should query the ViewChild `fxLayout` directive properly', inject([StyleService],
    ...
    it('should query the ViewChild `fxFlex` directive properly', inject([StyleService],
      (styleService: StyleService) => {
        fixture = TestBed.createComponent(TestQueryWithFlexComponent);
        fixture.detectChanges();
        ...
        let nodes = queryFor(fixture, '[fxFlex]');
        expect(nodes.length).toEqual(1);
        expectEl(nodes[0]).toHaveStyle({'max-width': '50%'}, styleService);
        ...
        nodes = queryFor(fixture, '[fxFlex]');
        expect(nodes.length).toEqual(1);
        expectEl(nodes[0]).toHaveStyle({'max-width': '35%'}, styleService);
        ...
        nodes = queryFor(fixture, '[fxFlex]');
        expect(nodes.length).toEqual(1);
        expectEl(nodes[0]).toHaveStyle({'max-width': '27.5px'}, styleService);
      })
    );

    it('should restore `fxFlex` value after breakpoint activations',
      inject([MatchMedia, StyleService],
        (_matchMedia: MockMatchMedia, styleService: StyleService) => {
          fixture = TestBed.createComponent(TestQueryWithFlexComponent);
          fixture.detectChanges();
          ...
          nodes = queryFor(fixture, '[fxFlex]');
          expectEl(nodes[0]).toHaveStyle({'max-width': '71%'}, styleService);
